            ...
            if (!empty($request->data)) {
                ...
                if ($this->ScaffoldModel->save($request->data)) {
                    if ($this->controller->afterScaffoldSave($action)) {
                        ...
                        if ($action === 'add') {
                            $message = __d('cake', '%1$s criado com sucesso', Inflector::humanize($this->modelKey), $success
                            );
                        } else {
                            $message = __d('cake', '%1$s salvo com sucesso', Inflector::humanize($this->modelKey), $success
                            );
                        }
                    ...
                    if ($this->_validSession) {
                        $this->controller->Session->setFlash(__d('cake', 'Favor preencher os campos corretamente.'));
                    }
                }
            }
