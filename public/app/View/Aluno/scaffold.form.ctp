<div class="form aluno">
    ...
    <div class="well">
        ...
        <div class="row-fluid">
            <?
            echo $this->Form->input('Aluno.rg', $this->Html->inRequest('rg', array('label' => 'RG', 'div' => 'span2', 'style' => 'width:100px;')));
            echo $this->Form->input('Aluno.nome', array('div' => 'span4'));
            echo $this->Form->input('Aluno.data_nascimento', array('dateFormat' => 'DMY', 'div' => 'span5'));
            ?>
        </div>
        <div class="row-fluid">
            <?
        ...
        <div class="row-fluid">
            <?
            echo $this->Form->input('Aluno.cep', array('label' => 'CEP', 'div' => 'span2', 'style'=>'width:100px;'));
            echo $this->Form->input('Aluno.logradouro', array('label' => 'Logradouro', 'div' => 'span3', 'style'=>'width:160px'));
            echo $this->Form->input('Aluno.numero', array('label' => 'Nº', 'div' => 'span1', 'style'=>'width:40px;'));
            echo $this->Form->input('Aluno.bairro', array('label' => 'Bairro', 'div' => 'span2', 'style'=>'width:100px;'));
            echo $this->Form->input('Aluno.cidade', array('label' => 'Cidade', 'div' => 'span3', 'style'=>'width:200px;'));
            ?>
        </div>
        <?= $this->Form->end(); ?>
    </div>